        ...
        <div className="">
           ...
           {expand == 56 && ( 
                ...
                {prevPrompts.map((item, index) => {
                    return (
                    <div key={index} onClick={(item) => loadPrompt(item)} className="inline-flex px-5 gap-3 place-items-center cursor-pointer hover:bg-gray-200 p-3 rounded-full justify-start transition-colors">
